# Generated by Django 5.2.1 on 2025-06-06 13:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('county_name', models.CharField(blank=True, max_length=250, null=True)),
                ...
                ('metro_code', models.CharField(blank=True, max_length=250, null=True)),
                ('timezone', models.CharField(blank=True, max_length=100, null=True)),
                ('dma_code', models.CharField(blank=True, max_length=250, null=True)),
                ('eventbrite_slug', models.CharField(blank=True, max_length=50, null=True)),
                ('all_event_in_slug', models.CharField(blank=True, max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cookies_id', models.CharField(blank=True, max_length=200, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event_image', models.FileField(blank=True, null=True, upload_to='event')),
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('start_date', models.DateField()),
                ('when', models.CharField(blank=True, max_length=100, null=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('venue', models.CharField(max_length=400)),
                ('event_source', models.CharField(choices=[('all_events_in', 'All Events In'), ('eventbrite', 'Eventbrite'), ('user_submitted', 'User Submitted'), ('serp_api_google_event', 'Google Event Search')], default='serp_api_google_event', max_length=50)),
                ('link', models.URLField(blank=True, null=True)),
                ('submitter_first_name', models.CharField(blank=True, max_length=300, null=True)),
                ('submitter_last_name', models.CharField(blank=True, max_length=300, null=True)),
                ('submitter_email', models.EmailField(blank=True, max_length=300, null=True)),
                ('submitter_phone', models.CharField(blank=True, max_length=300, null=True)),
                ('submitter_account_created', models.BooleanField(default=False)),
                ('city', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='events', to='event.city')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('active', models.BooleanField(default=True)),
                ('added_by', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='search_phrase', to=settings.AUTH_USER_MODEL)),
                ('location', models.ManyToManyField(to='event.location')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timestamp', models.DateTimeField(auto_now_add=True)),
                ('active', models.BooleanField(default=True)),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rel_zip_codes', to='event.city')),
                ('state', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='rel_zip_codes', to='event.location')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='city',
            name='area_code',
            field=models.ManyToManyField(blank=True, related_name='rel_cities', to='event.zipcode'),
        ),
    ]
